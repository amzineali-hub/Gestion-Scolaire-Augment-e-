    ...
    <div dir={lang === "ar" ? "rtl" : "ltr"} className="min-h-screen bg-slate-50 flex flex-col font-sans selection:bg-indigo-150 selection:text-indigo-900 max-w-full overflow-x-hidden">
      ...
      <header className="print:hidden bg-white border-b border-slate-150 py-3 sm:h-20 shrink-0 flex flex-wrap sm:flex-nowrap items-center justify-between px-3 md:px-6 sticky top-0 z-40 w-full gap-3">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0 min-w-0">
          {/* Logo element */}
          <div className="h-12 w-12 sm:h-14 sm:w-14 lg:h-16 lg:w-16 rounded-xl flex items-center justify-center overflow-hidden bg-[#0d2a4a] border border-slate-200/80 shadow-md shrink-0 group relative cursor-pointer transition-all hover:scale-[1.05] active:scale-[0.98] hover:ring-4 hover:ring-indigo-200/50" onClick={() => setActiveTab("settings")} title="Gérer le logo de l'établissement">
            {schoolLogo ? (
              <img 
                src={schoolLogo} 
                alt="Logo École" 
          ...
          <div className="hidden xs:block min-w-0">
            <h1 className="font-extrabold text-slate-850 tracking-tight text-sm sm:text-base leading-tight flex items-center gap-2 font-sans truncate">
              ...
              <span className="hidden md:inline-block text-[10px] bg-indigo-50 text-indigo-700 px-1.5 py-0.5 rounded font-bold border border-indigo-100 uppercase shrink-0">SAAS</span>
              <span className="hidden xl:inline-flex items-center gap-1 text-[9px] bg-emerald-50 text-emerald-800 px-1.5 py-0.5 rounded-lg font-black border border-emerald-200/80 shrink-0 shadow-xs">
                ...
                <span className="tracking-wide uppercase">{loadingInitial ? "SYNCHRONISATION..." : "EN LIGNE"}</span>
              </span>
            </h1>
            <p className="text-[10px] text-black mt-0.5 font-medium truncate">{t("school_portal")}</p>
          </div>
        </div>
        ...
        <div className="flex flex-1 items-center justify-center gap-1.5 sm:gap-2 mx-1 sm:mx-2 min-w-0 order-3 sm:order-none w-full sm:w-auto mt-2 sm:mt-0">
          ...
          <div className="flex items-center gap-1 sm:gap-2 bg-slate-100 px-2 sm:px-3 py-1.5 rounded-xl border border-slate-200 shrink-0">
            <span className="hidden sm:inline-block text-[10px] font-bold text-slate-500 uppercase">Rôle:</span>
            <select 
